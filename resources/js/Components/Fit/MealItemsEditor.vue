    ...
    <ul class="space-y-2">
        <li v-for="(item, index) in items" :key="index" class="rounded-2xl border border-white/5 bg-panel p-3.5">
            ...
            <div class="mt-2.5 flex items-center gap-2">
                <button type="button" aria-label="Mai puțin" class="flex size-10 items-center justify-center rounded-xl bg-white/5 text-white/70 active:scale-90"
                        @click="step(item, index, 0.9)">
                    <MinusIcon class="size-4"/>
                </button>
                <label class="flex h-10 items-center gap-1.5 rounded-xl bg-white/5 px-3">
                ...
                <button type="button" aria-label="Mai mult" class="flex size-10 items-center justify-center rounded-xl bg-white/5 text-white/70 active:scale-90"
                ...
                <button v-if="allowFavorite" type="button" aria-label="Favorit"
                        class="rounded-full p-2 transition active:scale-90"
                ...
                <button type="button" aria-label="Elimină" class="rounded-full p-2 text-white/35 active:scale-90 active:text-rose"
