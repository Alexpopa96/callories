...
/**
 * Daily cap on workout coach questions per user: every question is a paid API call.
 */
class WorkoutQuota
{
    public function limit(): int
    {
        return (int) config('services.anthropic.daily_workout_limit');
    }
    ...
    {
        return "workout:{$user->id}:".now()->toDateString();
    }
}
